...
def mask_image():
    ...
    for i in range(0, detections.shape[2]):
        ...
        if confidence > 0.5:
            ...
            # label = list(model.model_classes_.keys())[idx]
            # color = colors[idx]
            # pourcentage = predictions[0][idx]

            # if homeMade > mask:
            #     pourcentage = homeMade
            #     label = "Home made mask"
            #     color = (255, 0, 0)
